...
var _createClass = function() {
    ...
    leftDistance: function(a) {
        for (var b = a.offsetLeft, c = void 0; a.offsetParent; )
            a = a.offsetParent,
                b += a.offsetLeft;
        return c = document.body.scrollLeft + document.documentElement.scrollLeft,
        b - c
    },
    ...
    function a(b) {
        ...
        if (_classCallCheck(this, a),
                instance)
            return console.error("SKPlayer只能存在一个实例！"),
                Object.create(null);
        instance = !0;
        var d = {
        ...
        for (var e in d)
            b.hasOwnProperty(e) || (b[e] = d[e]);
        if (this.option = b,
                !(this.option.music && this.option.music.type && this.option.music.source))
            return console.error("请正确配置对象！"),
                Object.create(null);
        this.root = this.option.element,
            ...
            "file" === this.type ? (this.root.innerHTML = this.template(),
                this.init(),
                this.bind(),
                this.isReady = !0) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading"><span></span> <span></span> <span></span> <span></span><span></span></p>',
                Util.ajax({
    ...
    return _createClass(a, [{
        ...
        value: function() {
            ...
            this.updateLine = function() {
                ...
                this.audio.addEventListener("durationchange", function(b) {
                    a.dom.timetext_total.innerHTML = Util.timeFormat(a.audio.duration),
                        a.updateLine()
                }),
                ...
                this.audio.addEventListener("timeupdate", function(b) {
                    ...
                    a.dom.timeline_played.style.width = Util.percentFormat(c),
                        a.dom.timetext_played.innerHTML = Util.timeFormat(a.audio.currentTime)
                }),
            ...
            this.isMobile || this.dom.volumebutton.addEventListener("click", this.toggleMute),
                ...
                this.dom.musiclist.addEventListener("click", function(b) {
                    var c = void 0
                        , d = void 0
                        , e = void 0;
                    if ("LI" === b.target.tagName.toUpperCase())
                        c = b.target;
                    else {
                        if ("LI" !== b.target.parentElement.tagName.toUpperCase())
                            return;
                        c = b.target.parentElement
                    }
                    d = parseInt(c.getAttribute("data-index")),
                        e = parseInt(a.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index")),
                        d === e ? a.play() : a.switchMusic(d + 1)
                }),
                this.dom.timeline_total.addEventListener("click", function(b) {
                    ...
                    isNaN(a.audio.duration) || (a.dom.timeline_played.style.width = Util.percentFormat(d),
                        a.dom.timetext_played.innerHTML = Util.timeFormat(d * a.audio.duration),
                        a.audio.currentTime = d * a.audio.duration)
                }),
            this.isMobile || this.dom.volumeline_total.addEventListener("click", function(b) {
                ...
                a.dom.volumeline_value.style.width = Util.percentFormat(d),
                    a.audio.volume = d,
                a.audio.muted && a.toggleMute()
            })
        }
    }, {
        key: "prev",
        ...
        key: "errorHandle",
        value: function(a) {
            this.dom.musicitem[a].classList.add("invalid-name"),
                $.message({
                    title: LocalConst.MUSIC_NOTICE,
        ...
        value: function(a) {
            var b = this;
            return "number" != typeof a ? void console.error("请输入正确的歌曲序号！") : (a -= 1) < 0 || a >= this.music.length ? void console.error("请输入正确的歌曲序号！") : a == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index") ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"),
                this.dom.musicitem[a].classList.add("skPlayer-curMusic"),
                this.dom.name.innerHTML = this.music[a].name,
                this.dom.author.innerHTML = this.music[a].author,
                this.dom.cover.src = this.music[a].cover,
                void ("file" === this.type ? void 0 !== this.music[a].src ? (this.audio.src = this.music[a].src,
                    this.isReady = !0,
                    this.play()) : this.errorHandle(a) : "cloud" === this.type && Util.ajax({
                    url: baseUrl + "?type=song&media=" + this.media + "&id=" + this.music[a].song_id,
                    beforeSend: function() {},
                    success: function(a) {
                        var c = JSON.parse(a).url;
                        null !== c ? (b.audio.src = c,
                            b.isReady = !0,
                            b.play()) : 1 !== b.music.length && b.next()
                    },
                    fail: function(a) {
                        console.error("歌曲拉取失败！ 错误码：" + a)
                    }
        ...
        value: function() {
            ...
            this.audio.paused && (this.audio.play(),
                ...
                this.dom.runIcon.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>')
        }
    }, {
        key: "pause",
        value: function() {
            this.audio.paused || (this.audio.pause(),
                ...
                this.dom.runIcon.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>')
        }
    }, {
        key: "toggle",
        value: function() {
        ...
        value: function() {
            this.audio.muted ? (this.audio.muted = !1,
                this.dom.volumebutton.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>',
                this.dom.volumeline_value.style.width = Util.percentFormat(this.audio.volume)) : (this.audio.muted = !0,
                this.dom.volumebutton.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><line x1="23" y1="9" x2="17" y2="15"></line><line x1="17" y1="9" x2="23" y2="15"></line></svg>',
                this.dom.volumeline_value.style.width = "0%")
        }
    }, {
        key: "switchMode",
        value: function() {
            this.audio.loop ? (this.audio.loop = !1,
                this.dom.modebutton.classList.remove("skPlayer-mode-loop")) : (this.audio.loop = !0,
