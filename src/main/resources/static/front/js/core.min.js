...
var parsePhotos = function () {
    $.each($(".album-photos figure"), function (a, b) {
        var c = new Image;
       c.src = $(b).find("img").attr("src"), c.onload = function () {
    ...
    $("#search_input").on("input", function () {
        setTimeout(function () {
            a || (null !== c && clearTimeout(c), c = setTimeout(function () {
                ...
                if ("" !== a.trim()) {
                    $("#spin-search").addClass("show inline"), $("#icon-search").addClass("hide"), null !== b && (b.abort(), b = null), b = $.getJSON("?action=ajax_search&content=" + a, function (a) {
                        $("#search_tips_drop").text(""), $("#search_tips_drop").removeClass("hide"), $(a.results).appendTo("#search_tips_drop"), $("#spin-search").removeClass("show inline"), $("#icon-search").removeClass("hide"), b = null
                    })
...
$.extend({
    ...
    var b = function () {
        ...
        }), a('[data-toggle="tooltip"]').tooltip(),  (m(), a(function () {
        ...
        })) , r(), o(), "function" == typeof registCommentEvent && registCommentEvent(),  t(), j(), h(), i(), k(), f(), window.Page.seFancyBox(), a("#post-content").find("table").wrap("<div class='table-responsive box-shadow-wrap-lg'></div>"),  s(), d(), c()
    }, c = function () {
        ...
        a('input[name = "mail"]').blur(function () {
            ...
            return "" != b && a.ajax({
                type: "GET",
                data: {action: "ajax_avatar_get",email: b},
                success: function (b) {
            ...
            return a("#secret_comment_checkbox").is(":checked") && (l[0].value = "[secret]" + l[0].value + "\n[/secret]"), a(h).addClass("active"), a("#spin").addClass("show inline"), a.ajax({
                ...
                success: function (k) {
                    ...
                    try {
                        ...
                        var l;
                        a(e).length && (l = parseInt(a(e).text().match(/\d+/)), a(e).html(a(e).html().replace(l, l + 1))), TypechoComment.cancelReply(), a(g).val(""), a(f + " a, #cancel-comment-reply-link").unbind("click"), b(), a(h).attr("disabled", !1).fadeTo("slow", 1), i ? d.animate({scrollTop: a("#comment-" + i).offset().top}, 500) : d.animate({scrollTop: a("#comments").offset().top}, 500)
                    } catch (a) {
        ...
        window.location.hash.indexOf("#") >= 0 && a(b).length && setTimeout(function () {
            a("html,body").animate({scrollTop: a(b).offset().top  + "px"}, 400)
        }, 700)
    };
    window.Page = {
        seFancyBox: function () {
