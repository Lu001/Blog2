...
(function () {
    ...
    var e = this, f = e._, g = Array.prototype, h = Object.prototype, i = Function.prototype, j = g.push, k = g.slice,
        l = h.toString, m = h.hasOwnProperty, n = Array.isArray, o = Object.keys, p = i.bind, q = Object.create,
        r = function () {
        }, s = function (a) {
...
var _handsomeCustomizerSettings = {
    ...
    sections: {
        ...
        colors: [{
            ...
            aside: "bg-black"
        }, {navbarHeader: "bg-dark", navbarCollapse: "bg-white-only", aside: "bg-dark"}, {
            navbarHeader: "bg-white-only",
            navbarCollapse: "bg-white-only",
            aside: "bg-black"
        }, {navbarHeader: "bg-primary", navbarCollapse: "bg-white-only", aside: "bg-dark"}, {
            navbarHeader: "bg-info",
            navbarCollapse: "bg-white-only",
            aside: "bg-black"
        }, {navbarHeader: "bg-success", navbarCollapse: "bg-white-only", aside: "bg-dark"}, {
            navbarHeader: "bg-danger",
            navbarCollapse: "bg-white-only",
            aside: "bg-dark"
        }, {navbarHeader: "bg-black", navbarCollapse: "bg-black", aside: "bg-white"}, {
            ...
            aside: "bg-light dker"
        }, {navbarHeader: "bg-primary", navbarCollapse: "bg-primary", aside: "bg-dark"}, {
            navbarHeader: "bg-info dker",
            navbarCollapse: "bg-info dk",
            aside: "bg-black"
        }, {navbarHeader: "bg-success", navbarCollapse: "bg-success", aside: "bg-dark"}, {
            navbarHeader: "bg-danger",
    ...
    function f() {
        function c() {
            if (!r) {
                ...
                r = !0, q = f().appendTo("body"), i()
            }
        }

        function f() {
            var b = {sections: d.sections, defaults: a.extend({}, d.defaults, p())}, c = wp.template("customizer"),
                e = c(b), e = a(e);
            return e.find(":input").change(g), e.find("[name=reset]").click(h), e
        }

        function g() {
            var b = a(this).attr("name"), c = m(b);
            j(b, c), p(b, c), o("aside-fix") && o("aside-dock") && !o("header-fixed") && (m("header-fixed", !0), j("header-fixed", !0), p("header-fixed", !0))
        }
        ...
        function j(b, c) {
            switch (b) {
                ...
                case"aside-dock":
                case"layout-boxed":
                    var d = (c ? "add" : "remove") + "Class", e = (c ? "remove" : "add") + "Class", f = a(".app");
                    "layout-boxed" === b ? (f[d]("container"), f[e]("no-container"), a("html")[d]("bg")) : f[d]("app-" + b);
                    break;
                case"color":
                    k(c)
            }
        ...
        function k(a) {
            l("#header > .navbar-header", "navbarHeader", a), l("#header > .collapse", "navbarCollapse", a), l("#aside", "aside", a)
        }
        ...
        function m(b, c) {
            var d;
            return q.find(":input").each(function () {
                var f, g = a(this);
                if (g.attr("name") === b) {
        ...
        function p(b, c) {
            var f, g = d.localStorageKey, h = s.getItem(g);
            return f = h ? JSON.parse(h) : {}, b ? c === e ? f[b] : (null === c ? delete f[b] : f[b] = c, a.isEmptyObject(f) ? s.removeItem(g) : s.setItem(g, JSON.stringify(f))) : null === b && null === c ? s.removeItem(g) : f
        }

        var q, r = !1, s = b.localStorage;
        return s && a(c), {
            load: c,
